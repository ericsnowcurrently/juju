...
type initSystemCommands struct{}

func (isc *initSystemCommands) List() (string, error) {
	return nil, errors.NotSupportedf(`"List" command`)
}

func (isc *initSystemCommands) Install(conf *common.Conf) ([]string, error) {
}
...
func (is *initSystem) Commands() common.InitSystemCommands {
	return &initSystemCommands{}
}
