...
func (b *CreateSuite) SetUpTest(c *gc.C) {
	b.cwd = c.MkDir()
	b.BaseSuite.SetUpTest(c)
}

func (b *CreateSuite) createTestFiles(c *gc.C) {
...
func (b *CreateSuite) removeTestFiles(c *gc.C) {
...
func (b *CreateSuite) assertTarContents(c *gc.C, expectedContents []expectedTarContents,
	tarFile string,
	compressed bool) {
...
func (b *CreateSuite) TestBackup(c *gc.C) {
	b.createTestFiles(c)
